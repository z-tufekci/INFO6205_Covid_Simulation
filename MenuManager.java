...
public class MenuManager implements ActionListener {
	 ...
	 */
	public MenuManager(App application) {
	 ...
	 */
	public MenuManager(App application, String text) {
		this.application = application;
		this.text=text;
		this.id = "menu-" + Integer.toString(counter++);
		init();
	 ...
	 */
	public MenuManager(App application, String text, String id) {
		this.application = application;
		this.text = text;
		this.id = id;
		init();
	...
	class ExitAction extends AbstractAction {
		...
		protected ExitAction(App application) {
			super("ExitAction");
			this.application = application;
		}
	...
	class AboutAction extends AbstractAction {
		...
		protected AboutAction(App application) {
			super("AboutAction");
			this.application = application;
		}
